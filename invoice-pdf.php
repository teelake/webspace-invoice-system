...
<div class="invoice">
    <div class="header">
        <div>
            <?php if (!empty($company['logo_url'])): ?><img src="<?= htmlspecialchars($company['logo_url']) ?>" alt="Logo" style="height:80px; width:auto;"><br><?php else: ?><h2 style="margin:0; color:<?= $accent ?>"><?= htmlspecialchars($company['company_name'] ?? 'Company') ?></h2><?php endif; ?>
